...
import type { InboundAdapter, AddressingPolicy, ContentItem, ThreadRef } from './contracts';
import type { RuleConfig } from '../rules/rule';
...
//                    不支持多段回复 / 不读它的 channel 忽略即可,字段可选。
...
export interface ChannelPlugin {
    channel: string; // 该插件负责的渠道标识，与 bot_config.channel 同口径
