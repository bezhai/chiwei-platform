...
// botIdentity（addressing_hints 由 inbound 从 mentions[].id.union_id 产出，与
// botIdentity=robot_union_id 同口径）。botIdentity 由调用方按 channel 取（飞书
...
function decide(msg: InboundMessage, botIdentity: string): AddressingDecision {
