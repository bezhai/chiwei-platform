...
from app.api.file_pipeline import router as file_pipeline_router
...
api_router.include_router(file_pipeline_router, prefix="/file-pipeline", tags=["file-pipeline"])
