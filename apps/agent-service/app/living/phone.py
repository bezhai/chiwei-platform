...
**没人在叫她时分两种，不是一种。** 她这条会话上**已经有水位**（翻过至少一页）时锚点
是最早那条还没看过的 —— 也就是接着上一页往下读；**从没打开过、或者已经追平了未读**时
才落在最新那条上，那时这一页就是最后几条，跟真人点开一个群一样。少了中间这一档，群里
那条 @ 读完之后再打开就一路跳到最新：中间几十条一个字没摆到她眼前，却随着水位一起过
去了。私聊上遇不到这一档 —— 那儿每一条未读都在叫她。
...
async def look_at_phone(
    ...
    你还没看过的），前后各带一段。没人在叫你的时候：这条会话你翻过了就接着上次那页
    往下给，一次一页，没看过的一条都不会被跳过；翻完了、或者你从没打开过它，就是最后
    那几条。
    ...
    **你自己发出去的图不会再摆一遍**，只在正文里留一个 `[你发的图 pic=…]`：你发的
    ...
    Args:
        ...
        before: 往前翻一页（这一页头上那串 before=…）；不填就是接着往下的那一页。
