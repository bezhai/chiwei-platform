...
**眼睛——world 的感官，不是独立服务。** 它跟反思、续写一样是 world 的一个环节（同一份世界底色、同族 prompt、产出朝向世界），不是「fetch agent 升级」——fetch 这个独立服务的概念就此消解，凌晨的 cron 和底料表只是它的钟和落脚处。感知分两层：**本能的扫视**（开发者定的每天必抓：天气、日出日落、农历节气、节假日——人人被罩着的环境量）+ **有意的张望**（world 自己交代的关注：反思对表时发现「在等放榜但不知道哪天出分」，就把这个关注留给眼睛，明早眼睛带着它去看）。由此感知成为闭环：眼睛看回来 → 反思消化、生出新关注 → 交代眼睛 → 明早接着看——世界的注意力自己会转，不靠开发者人肉指方向。关注落独立的小版本链（自然语言；长弧写「走到哪」、关注写「想看哪」，语义不混放），细节 spec 时定。**番剧是两层分界的试金石**：「抓当季全部番」就是把有意的张望硬塞进本能清单的错位——番剧不是环境量，谁追什么番是世界里长出来的事实，该由 world 交代眼睛去看「她追的那部更新没」，连发现新番也是换季时 world 自己起的关注。**原始外部消息从此不直接进续写。**
